...
THESIS="${LIVE_THESIS:-0x12404Ce775a22532bE58e0105252819A982cFB21}"
COLLATERAL="${LIVE_COLLATERAL:-0x256049FCac7349bd037fecb4D849be2610392Ee1}"
FROM_BLOCK="${LIVE_FROM_BLOCK:-120851302}"
EXPECTED_CLAIMS=3
