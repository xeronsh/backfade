...
const buttonVariants = cva(
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-button border px-4 text-sm font-medium transition-colors duration-160 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
