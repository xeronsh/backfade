...
const buttonVariants = cva(
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-button border px-4 text-sm font-medium transition-[color,background-color,border-color,transform] duration-220 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        primary:
          "button-primary border-brand bg-brand text-brand-on hover:bg-brand-hover active:bg-brand-pressed",
        ghost:
